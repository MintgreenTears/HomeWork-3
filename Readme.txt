——————————————————————————————————————————————————
Assignment 3 
"A Palmful of Paper Money"
Animations, Physics, and Audio
4/15/2024

This Assignment comes from the GAME351
which uses some resources from Professor

Since it was impossible to ensure that the team members could complete the task on time, 
it seemed that the remaining two team members would be busy on the weekend, 
so Wenkang and Yida completed all the rest of the work.
——————————————————————————————————————————————————
Group work
Task 1: Wenkang Lyu
Task 2: Yida Fang
